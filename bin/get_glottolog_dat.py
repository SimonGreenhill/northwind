...
LOCATIONS = {"npi": (27.7, 85.316667), "nuk": (54, -125)}

columns = ["ID", "ISO", "Language", "Family", "Latitude", "Longitude", "Classification"]
...
def get_values(filename):
    ...
    if len(classif) == 0:  # pragma: no cover
        classif = [j["name"]]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Constructs a glottolog data file")
